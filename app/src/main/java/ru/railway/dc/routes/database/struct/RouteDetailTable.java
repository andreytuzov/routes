...
public class RouteDetailTable {

    // Таблица для хранения кэша
    public static final String TABLE_ROUTE_DETAIL = "tableRouteDetail";
    ...
    public static final String COLUMN_ROUTE_TABLE_ID = "routeDetailTableID";

    public static final String SQL_DB_TABLE_ROUTE_DETAIL_CREATE =
            "create table " + TABLE_ROUTE_DETAIL + "(" +
